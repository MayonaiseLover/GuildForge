  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 flex items-center justify-center p-8">
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <h1 className="text-2xl font-bold text-white">Monitoring Unavailable</h1>
        <p className="text-slate-400 text-sm leading-relaxed">
          {error.message || "Failed to load server health data. Your servers are still being monitored."}
        </p>
